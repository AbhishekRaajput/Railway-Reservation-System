...
float tamt;
    ...
    class detail
    {
        ...
        void getdetail()
        {
            ...
            cout<<"Train no: ";cin>>tno;cout<<endl;
            cout<<"Train name: ";cin>>tname;cout<<endl;
            cout<<"Boarding point: ";cin>>bp;cout<<endl;
            cout<<"Destination pt: ";cin>>dest;cout<<endl;
            cout<<"No of seats in first class & fare per ticket: ";
            cin>>c1>>c1fare;cout<<endl;
            cout<<"No of seats in second class & fare per ticket: ";
            cin>>c2>>c2fare;cout<<endl;
            cout<<"Date of travel: ";cin>>d>>m>>y;cout<<endl;
        }
        ...
        void displaydetail()
        {
            ...
            cout<<"Destination Point              : "<<dest<<endl;
            cout<<"Number of Seats in First Class : "<<c1<<endl;
            cout<<"Fare per Ticket in First Class : "<<c1fare<<endl;
            cout<<"Number of Seats in Second Class: "<<c2<<endl;
            cout<<"Fare per Ticket in Second Class: "<<c2fare<<endl;
    ...
    class reser
    {
        ...
        void getresdet()
        {
            ...
            cout<<"Train name:";cin>>tname;
            cout<<"Boarding point:";cin>>bp;
            cout<<"Destination pt:";cin>>dest;
            cout<<"No of seats requiz:";cin>>nosr;
            
            for(i=0;i<nosr;i++)
            {
                cout<<"Passenger name:";cin>>pname[i];
